package com.hollysmart.basemodule.view.statusbar;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.BaseModuleStatusBarHeightView);
            type = typedArray.getInt(R.styleable.BaseModuleStatusBarHeightView_form_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
